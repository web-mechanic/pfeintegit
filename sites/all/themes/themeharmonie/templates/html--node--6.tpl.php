...
<head profile="<?php print $grddl_profile; ?>">
  ...
  <meta name="description" content="L'Harmonie d'Antheit est une société musicale wallone active et moderne ouverte au monde et aux musiciens de tout horizons. ">
...
<body class="<?php print $classes; ?>" <?php print $attributes;?>>
  ...
  ga('create', 'UA-41651761-1', 'harmonie-antheit.be');
  ga('send', 'pageview');
